...
func (s *createRunRepositoryStub) RunsByOwnerID(context.Context, bots.UserID) ([]*bots.Run, error) {
	return nil, nil
}

func (s *createRunRepositoryStub) RunsByBotID(context.Context, bots.BotID) ([]*bots.Run, error) {
	return nil, nil
}
